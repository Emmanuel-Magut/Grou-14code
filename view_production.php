...
$records = htmlspecialchars($row[0], ENT_QUOTES);
 ...
 $query = "SELECT production_id, litres_produced, litres_sold, date_produced AS regdat FROM milk_production ORDER BY date_produced ASC"; // #5
...
//  " AS regdat FROM family_members ORDER BY registration_date ASC";
 ...
 echo '<tr>
 <td><a href="edit_production.php?id=' . $production_id .'" class="btn btn-success btn-sm">Edit</a></td>
 <td><a href="delete_production.php?id=' . $production_id .'" class="btn btn-danger btn-sm">Delete</a></td>
